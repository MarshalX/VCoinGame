...
if __name__ == '__main__':
    ...
    def update_status():
        ...
        transactions = [transaction for transaction in transactions \
                        if transaction.from_id != merchant_id and transaction.payload == int(CoinAPI.PAYLOAD)]
