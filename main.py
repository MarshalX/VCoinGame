...
🛑 Будь осторожнее 🛑 Если ты жмёшь Подкинуть монетку, то твой текущий выигрыш тебе не начисляется!
...
🛑 Если Вы начинаете играть новый раунд, Ваш текущий приз может сгореть, будьте осторожнее! 🛑
Новая ставка составляет {}"""
